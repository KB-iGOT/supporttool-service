...
interface CreateCompetencySubThemeDialogProps {
    open: boolean;
    onClose: () => void;
...
export const CreateCompetencySubThemeDialog: React.FC<CreateCompetencySubThemeDialogProps> = ({
    open,
    onClose,
    onSubmit,
    processing,
    ...
    const handleSubmit = () => {
        ...
        onSubmit(subThemeData);
    };

    return (
        <Dialog open={open} onClose={onClose} maxWidth="md" fullWidth>
            <DialogTitle>Create Competency Sub-Theme</DialogTitle>
            <DialogContent>
